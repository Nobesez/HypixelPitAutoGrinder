...
public class Bot {
    ...
    public void fighting(TickEvent.ClientTickEvent e) {
        ...
        for (int slot = 8; slot >= 0; slot--) {
            ...
            if (itemInSlot != null) {
                if ((Utils.isGoldenApple(itemInSlot) || Utils.isGoldenHead(itemInSlot) || Utils.isSoup(itemInSlot) || Utils.isBakedPotato(itemInSlot)) || Utils.isOlympusPotion(itemInSlot) && mc.field_71439_g.func_110143_aJ() != mc.field_71439_g.func_110138_aP() && gheadtickdelay == 0) {
                    setPhase(GAPPING);
    ...
    public void gapping(TickEvent.ClientTickEvent e) {
        ...
        if (mc.field_71439_g.func_70694_bm()!=null) {
            if (Utils.isGoldenApple(mc.field_71439_g.func_70694_bm()) || Utils.isGoldenHead(mc.field_71439_g.func_70694_bm()) || Utils.isSoup(mc.field_71439_g.func_70694_bm()) || Utils.isOlympusPotion(mc.field_71439_g.func_70694_bm()) || Utils.isBakedPotato(mc.field_71439_g.func_70694_bm())){
                if (e.phase== TickEvent.Phase.START) {
                    ...
                    if (!mc.field_71439_g.func_71039_bw()) {
                        ...
                        if (Utils.isGoldenHead(mc.field_71439_g.func_70694_bm()) || Utils.isBakedPotato(mc.field_71439_g.func_70694_bm()) || Utils.isSoup(mc.field_71439_g.func_70694_bm())) {
