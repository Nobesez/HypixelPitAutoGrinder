...
public class Bot {
    ...
    public void fighting(TickEvent.ClientTickEvent e) {
        ...
        for (int slot = 8; slot >= 0; slot--) {
            ...
            if (itemInSlot != null) {
                if ((Utils.isGoldenApple(itemInSlot) || Utils.isGoldenHead(itemInSlot) || Utils.isBakedPotato(itemInSlot)) || Utils.isOlympusPotion(itemInSlot) && mc.thePlayer.getHealth() != mc.thePlayer.getMaxHealth() && gheadtickdelay == 0) {
                    setPhase(GAPPING);
    ...
    public void gapping(TickEvent.ClientTickEvent e) {
        ...
        if (mc.thePlayer.getHeldItem()!=null) {
            if (Utils.isGoldenApple(mc.thePlayer.getHeldItem()) || Utils.isGoldenHead(mc.thePlayer.getHeldItem()) || Utils.isOlympusPotion(mc.thePlayer.getHeldItem()) || Utils.isBakedPotato(mc.thePlayer.getHeldItem())){
                if (e.phase== TickEvent.Phase.START) {
                    ...
                    if (!mc.thePlayer.isUsingItem()) {
                        ...
                        if (Utils.isGoldenHead(mc.thePlayer.getHeldItem()) || Utils.isBakedPotato(mc.thePlayer.getHeldItem())) {
                            mc.thePlayer.sendQueue.addToSendQueue(new C08PacketPlayerBlockPlacement(mc.thePlayer.getHeldItem()));
                            startwalking();
                            setPhase(FIGHTING);
                            gheadtickdelay = gheaddelay;
                        } else if (Utils.isGoldenApple(mc.thePlayer.getHeldItem())) {
